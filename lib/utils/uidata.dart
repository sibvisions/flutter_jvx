...
class UIData {
  ...
  static const SIB_BLUE = MaterialColor(sibblue, <int, Color>{
    50: Color(sibblue),
  ...
  static const JVX_BLUE = MaterialColor(sibblue, <int, Color>{
...
//colors
  ...
  static List<Color> get kitGradients2 {
    return [UIData.ui_kit_color_2, UIData.ui_kit_color_2[400]];
  }
