...
//
// Source:
// https://github.com/google/dart-neats/tree/master/retry
// with https://github.com/google/dart-neats/pull/55
...
class RetryOptions {
  ...
  /// thrown, or if [retryIfResult] returns `true` for the value returned from [fn].
  ///
