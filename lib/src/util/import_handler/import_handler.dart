...
WebSocketChannel createWebSocket(Uri uri, Map<String, dynamic>? headers, Duration? connectTimeout) =>
    platform.ImportHandler.getWebSocketChannel(uri, headers, connectTimeout);
