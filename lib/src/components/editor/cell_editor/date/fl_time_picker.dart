...
/// See also:
///
/// * [showTimePicker], a function that shows a [FlTimePickerDialog] and returns
        ...
        child: InkWell(
          ...
          child: Center(
            child: Text(
              ...
              textScaler: MediaQuery.textScalerOf(context).clamp(maxScaleFactor: 0.5),
            ),
          ),
        ),
      ),
...
class _AmPmButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TimePickerThemeData timePickerTheme = _TimePickerModel.themeOf(context);
    final _TimePickerDefaults defaultTheme = _TimePickerModel.defaultThemeOf(context);
    final Color resolvedBackgroundColor = WidgetStateProperty.resolveAs<Color>(timePickerTheme.dayPeriodColor ?? defaultTheme.dayPeriodColor, states);
    final Color resolvedTextColor = WidgetStateProperty.resolveAs<Color>(timePickerTheme.dayPeriodTextColor ?? defaultTheme.dayPeriodTextColor, states);
    final TextStyle? resolvedTextStyle = WidgetStateProperty.resolveAs<TextStyle?>(timePickerTheme.dayPeriodTextStyle ?? defaultTheme.dayPeriodTextStyle, states)?.copyWith(color: resolvedTextColor);
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Color dialTextUnselectedColor = WidgetStateProperty
        .resolveAs<Color>(timePickerTheme.dialTextColor ?? defaultTheme.dialTextColor, <WidgetState>{ });
    final Color dialTextSelectedColor = WidgetStateProperty
        .resolveAs<Color>(timePickerTheme.dialTextColor ?? defaultTheme.dialTextColor, <WidgetState>{  WidgetState.selected });
    ...
    painter = _DialPainter(
      ...
      dotColor: dotColor,
      dotRadius: defaultTheme.dotRadius - 8,
...
class _HourMinuteTextFieldState extends State<_HourMinuteTextField> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle effectiveStyle = WidgetStateProperty.resolveAs<TextStyle>(widget.style, states)
        .copyWith(color: effectiveTextColor, fontSize: 60);
...
/// [Navigator.pop].
///
/// Use [showTimePicker] to show a dialog already containing a [FlTimePickerDialog].
class FlTimePickerDialog extends StatefulWidget {

  static const Object NULL_TIME = Object();

  /// Creates a Material Design time picker.
  const FlTimePickerDialog({
    super.key,
  ...
  ///
  /// When the clear button is pressed, the return value of the date picker is [NULL_TIME];
  final bool showClear;

  /// Restoration ID to save and restore the state of the [FlTimePickerDialog].
  ///
  ...
  @override
  State<FlTimePickerDialog> createState() => _FlTimePickerDialogState();
}

class _FlTimePickerDialogState extends State<FlTimePickerDialog> with RestorationMixin {
  ...
  static const Size _kTimePickerInputSize = Size(372, 216);
  ...
  void _handleClear() {
    Navigator.pop(context, FlTimePickerDialog.NULL_TIME);
  }
  ...
  Widget build(BuildContext context) {
      ...
      final Widget actions = Padding(
        padding: EdgeInsetsDirectional.only(start: theme.useMaterial3 ? 0 : 0),
        child: Row(
          children: <Widget>[
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    if (widget.showClear) const SizedBox(width: 8),
                    TextButton(
      ...
      return Dialog(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 24).copyWith(top: 20, bottom: 2) ,// pickerTheme.padding ?? defaultTheme.padding,
...
Future<TimeOfDay?> showTimePicker({
  ...
  final Widget dialog = FlTimePickerDialog(
...
class _TimePickerDefaultsM2 extends _TimePickerDefaults {
  ...
  BorderSide get dayPeriodBorderSide {
    return BorderSide(
      color: Color.alphaBlend(_colors.onSurface.withAlpha(Color.getAlphaFromOpacity(0.38)), _colors.surface),
    );
  }
  ...
  Color get dayPeriodColor {
    return WidgetStateColor.resolveWith((Set<WidgetState> states) {
      if (states.contains(WidgetState.selected)) {
        return _colors.primary.withAlpha(Color.getAlphaFromOpacity(_colors.brightness == Brightness.dark ? 0.24 : 0.12));
      }
  ...
  Color get dayPeriodTextColor {
    return  WidgetStateColor.resolveWith((Set<WidgetState> states) {
      return states.contains(WidgetState.selected) ? _colors.primary : _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(0.60));
    });
  }
  ...
  @override
  Color get dialBackgroundColor {
    return _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(_colors.brightness == Brightness.dark ? 0.12 : 0.08));
  }
  ...
  @override
  Color get entryModeIconColor {
    return _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(_colors.brightness == Brightness.dark ? 1.0 : 0.6));
  }
  ...
  Color get hourMinuteColor {
    return WidgetStateColor.resolveWith((Set<WidgetState> states) {
      return states.contains(WidgetState.selected)
          ? _colors.primary.withAlpha(Color.getAlphaFromOpacity(_colors.brightness == Brightness.dark ? 0.24 : 0.12))
          : _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(0.12));
    });
  }
  ...
  InputDecorationTheme get inputDecorationTheme {
    return InputDecorationTheme(
      ...
      hintStyle: hourMinuteTextStyle.copyWith(color: _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(0.36))),
    ...
    return WidgetStateColor.resolveWith((Set<WidgetState> states) {
      if (states.contains(WidgetState.selected)) {
        ...
        if (states.contains(WidgetState.pressed)) {
          ...
          overlayColor = _colors.onPrimaryContainer.withAlpha(Color.getAlphaFromOpacity(hoverOpacity));
        } else if (states.contains(WidgetState.focused)) {
          const double focusOpacity = 0.1;
          overlayColor = _colors.onPrimaryContainer.withAlpha(Color.getAlphaFromOpacity(focusOpacity));
        }
        ...
        if (states.contains(WidgetState.pressed)) {
          ...
          const double hoverOpacity = 0.08;
          overlayColor = _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(hoverOpacity));
        } else if (states.contains(WidgetState.focused)) {
          const double focusOpacity = 0.1;
          overlayColor = _colors.onSurface.withAlpha(Color.getAlphaFromOpacity(focusOpacity));
        }
