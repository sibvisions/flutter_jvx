...
/// push [FlDatePickerDialog] when the button is tapped.
///
...
Future<DateTime?> showDatePicker({
  ...
  Widget dialog = FlDatePickerDialog(
...
class FlDatePickerDialog extends StatefulWidget {
  ...
  /// Called when the [FlDatePickerDialog] is toggled between
              ...
              if (widget.showClear)
                Flexible(
                  ...
                  child: Align(
                    ...
                    child: TextButton(
                      style: datePickerTheme.confirmButtonStyle ?? datePickerTheme.confirmButtonStyle,
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isSelectedDayStart || widget.isSelectedDayEnd) {
      ...
      if (widget.isDisabled) {
        itemStyle = itemStyle?.apply(color: colorScheme.onSurface.withAlpha(Color.getAlphaFromOpacity((0.38))));
      }
