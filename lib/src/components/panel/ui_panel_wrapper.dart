...
class _UIPanelWrapperState extends State<UIPanelWrapper> with OnRegisterParentEvent, OnRegisterPreferredSizeEvent, ComponentStoreServiceMixin {
  ...
  void getChildSizes(Map<String, LayoutData> layoutData) {
  ...
  Widget _createPositionChildren(LayoutData? layoutData, Widget child){
