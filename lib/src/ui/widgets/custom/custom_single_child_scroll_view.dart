...
/// or pop-up menu. In that case, you might pair the [CustomSingleChildScrollView]
/// with a [ListBody] child.
///
/// When you have a list of children and do not require cross-axis
/// shrink-wrapping behavior, for example a scrolling list that is always the
/// width of the screen, consider [ListView], which is vastly more efficient
/// that a [CustomSingleChildScrollView] containing a [ListBody] or [Column] with
/// many children.
///
/// ## Sample code: Using [CustomSingleChildScrollView] with a [Column]
///
...
/// make sense to wrap the layout in a [CustomSingleChildScrollView].
///
/// Simply doing so, however, usually results in a conflict between the [Column],
/// which typically tries to grow as big as it can, and the [CustomSingleChildScrollView],
...
/// content beyond the dimensions of the screen, then [CustomSingleChildScrollView]
...
/// the constraints that the [CustomSingleChildScrollView] sees, since viewports
