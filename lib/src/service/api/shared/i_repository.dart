...
abstract class IRepository {
  ...
  /// Sends [request] via a long-running client and throws an exception if the request fails.
  Future<ApiInteraction> sendRequest(ApiRequest request, [bool? retryRequest]);
}
