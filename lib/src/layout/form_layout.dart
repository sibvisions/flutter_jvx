...
class FormLayout extends ILayout {
  ...
  Map<String, LayoutPosition> calculateLayout(LayoutData pParent) {
    ...
    const String layoutData = "b0,tm,-,0,0;b1,t1,-,a,0;b2,t2,-,0,0;tm,t,-,10,10;t,-,-,0,0;l1,r0,-,0,0;bm,b,-,-10,-10;b,-,-,0,0;b3,t3,-,a,0;r0,lm,-,0,0;r1,l1,-,a,0;t3,b2,-,0,0;t1,b0,-,0,0;t2,b1,-,5,5;r,-,-,0,0;rm,r,-,-10,-10;lm,l,-,10,10;l,-,-,0,0";

    /// LayoutString
    const String layout = "FormLayout,10,10,10,10,10,5,1,1";

    /// Position set by Parent
    final LayoutPosition? setPosition = LayoutPosition(height: 1080, width: 1920, isComponentSize: false);
    ...
    HashMap<String, FormLayoutConstraints> componentConstraints = FLUtil.getComponentConstraints(componentData, anchors);
    ...
    calculateAnchors(pAnchors: anchors, pComponentData: componentData,pComponentConstraints: componentConstraints,
        pUsedBorder: usedBorder, pPreferredMinimumSize: preferredMinimumSize, pGaps: gaps);

    calculateTargetDependentAnchors(pMinPrefSize: preferredMinimumSize, pAnchors: anchors, pHorizontalAlignment: horizontalAlignment,
        pVerticalAlignment: verticalAlignment, pUsedBorder: usedBorder, pMargins: margins, pComponentData: componentData, pComponentConstraints: componentConstraints, pGivenSize: setPosition);
  ...
  void calculateAnchors({required HashMap<String, FormLayoutAnchor> pAnchors, required HashMap<String, LayoutData> pComponentData,
    ...
    pComponentData.forEach((componentId, component) {
      ...
      FLCalculateAnchorsUtil.initAutoSizeRelative(pStartAnchor: constraint.leftAnchor, pEndAnchor: constraint.rightAnchor, pAnchors: pAnchors);
      FLCalculateAnchorsUtil.initAutoSizeRelative(pStartAnchor: constraint.rightAnchor, pEndAnchor: constraint.leftAnchor, pAnchors: pAnchors);
      FLCalculateAnchorsUtil.initAutoSizeRelative(pStartAnchor: constraint.topAnchor, pEndAnchor: constraint.bottomAnchor, pAnchors: pAnchors);
      FLCalculateAnchorsUtil.initAutoSizeRelative(pStartAnchor: constraint.bottomAnchor, pEndAnchor: constraint.topAnchor, pAnchors: pAnchors);
    });
    ...
    for(double autoSizeCount = 1; autoSizeCount > 0 && autoSizeCount < 10000000;){
      pComponentData.forEach((componentId, component) {
        ...
        if(true){
          ...
          FLCalculateAnchorsUtil.calculateAutoSize(leftTopAnchor: constraint.topAnchor, rightBottomAnchor: constraint.bottomAnchor, preferredSize: preferredSize.height, autoSizeCount: autoSizeCount, pAnchors: pAnchors);
          FLCalculateAnchorsUtil.calculateAutoSize(leftTopAnchor: constraint.leftAnchor, rightBottomAnchor: constraint.rightAnchor, preferredSize: preferredSize.height, autoSizeCount: autoSizeCount, pAnchors: pAnchors);
        }
      });
  ...
  void calculateTargetDependentAnchors({required FormLayoutSize pMinPrefSize, required HashMap<String, FormLayoutAnchor> pAnchors,
      required HorizontalAlignment pHorizontalAlignment, required VerticalAlignment pVerticalAlignment, required FormLayoutUsedBorder pUsedBorder,
        required Margins pMargins, required HashMap<String, LayoutData> pComponentData, required HashMap<String, FormLayoutConstraints> pComponentConstraints, LayoutPosition? pGivenSize }) {
    ...
    LayoutPosition calcSize = pGivenSize ?? LayoutPosition(width: 0, height: 0, isComponentSize: true);
    ...
    // Horizontal Alignment
    if(pHorizontalAlignment == HorizontalAlignment.stretch || (pUsedBorder.leftBorderUsed && pUsedBorder.rightBorderUsed)){
      if(minLayoutSize.width > calcSize.width){
        ...
        switch(pHorizontalAlignment){
          case HorizontalAlignment.left :
            lba.position = 0; break;
          case HorizontalAlignment.right :
            lba.position = calcSize.width - maxLayoutSize.width; break;
          default :
      ...
      if(pMinPrefSize.preferredWidth > calcSize.width){
        ...
        switch(pHorizontalAlignment){
          case HorizontalAlignment.left:
            lba.position = 0; break;
          case HorizontalAlignment.right:
            lba.position = calcSize.width - pMinPrefSize.preferredWidth; break;
          default :
    ...
    // Vertical Alignment
    if(pVerticalAlignment == VerticalAlignment.stretch || (pUsedBorder.bottomBorderUsed && pUsedBorder.topBorderUsed)){
      if(minLayoutSize.height > calcSize.height){
        ...
        switch(pVerticalAlignment){
          case VerticalAlignment.top :
            tba.position = 0; break;
          case VerticalAlignment.bottom :
            tba.position = calcSize.height - maxLayoutSize.height; break;
          default:
      ...
      if(pMinPrefSize.preferredHeight > calcSize.height) {
        ...
        switch(pVerticalAlignment){
          case VerticalAlignment.top:
            tba.position = 0; break;
          case VerticalAlignment.bottom:
            tba.position = calcSize.height - pMinPrefSize.preferredHeight; break;
          default :
    ...
    pComponentData.forEach((componentId, component) {
      ...
      if(true){
        ...
        FLCalculateDependentUtil.calculateRelativeAnchor(leftTopAnchor: constraints.leftAnchor, rightBottomAnchor: constraints.rightAnchor, preferredSize: preferredComponentSize.width);
        FLCalculateDependentUtil.calculateRelativeAnchor(leftTopAnchor: constraints.topAnchor, rightBottomAnchor: constraints.bottomAnchor, preferredSize: preferredComponentSize.height);
      }
    });
  }


  void buildComponents ({required HashMap<String, FormLayoutAnchor> pAnchors, required HashMap<String, FormLayoutConstraints> pComponentConstraints, required Margins pMargins}){
    ...
    /// Used for components
    FormLayoutConstraints marginConstraints = FormLayoutConstraints(bottomAnchor: bma, leftAnchor: lma, rightAnchor: rma, topAnchor: tma);
    /// Used for layoutSize
    FormLayoutConstraints borderConstraints = FormLayoutConstraints(bottomAnchor: bba, leftAnchor: lba, rightAnchor: rba, topAnchor: tba);
