...
class ComponentData {
  ...
  void updateDataProviderChanged(
      BuildContext context, JVxDataproviderChanged pDataproviderChanged) {
  ...
  void filterData(
    ...
    FilterData filter =
        FilterData(dataProvider, value, editorComponentId, null, 0, 100);
    filter.reload = true;
  ...
  void setValues(BuildContext context, List<dynamic> values,
    ...
    SetValues setValues =
        SetValues(this.dataProvider, data?.columnNames, values);
