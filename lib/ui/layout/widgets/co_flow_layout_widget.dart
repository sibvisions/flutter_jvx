...
class CoFlowLayoutWidget extends MultiChildRenderObjectWidget {
  ...
  // Class members
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  final Map<RenderBox, Component> constraintMap = <RenderBox, Component>{};
...
class RenderFlowLayoutWidget extends RenderBox
  ...
  Map<RenderBox, Component> constraintMap = <RenderBox, Component>{};
  ...
  void performLayout() {
    // Set components
    constraintMap = <RenderBox, Component>{};
  ...
  Size getPreferredSize(RenderBox renderBox, Component comp) {
  ...
  /*
	 ...
	 */
  void setConstraints(RenderBox pComponent, Component pConstraints) {
