...
import '../../container/co_container.dart';
import 'co_form_layout_anchor.dart';
import 'co_form_layout_contraint.dart';
import 'dart:math';
...
class RenderFormLayoutWidget extends RenderBox
  ...
  /*
     * {@inheritDoc}
     */
  Size minimumLayoutSize(CoContainer pTarget) {
  ...
  /*
     * {@inheritDoc}
     */
  Size preferredLayoutSize(CoContainer pTarget) {
  ...
  /*
     * {@inheritDoc}
     */
  Size maximumLayoutSize(CoContainer pTarget) {
  ...
  */
  ...
  void calculateAnchors(CoContainer pContainer) {
    if (!valid) {
  ...
  ///
  void doCalculateTargetDependentAnchors(CoContainer pTarget) {
