class LinkReference {
  ...
  LinkReference.fromJson(Map<String, dynamic> json) {
    if (json['columnNames'] != null) columnNames = List<String>.from(json['columnNames']);
    if (json['referencedColumnNames'] != null) referencedColumnNames = List<String>.from(json['referencedColumnNames']);
